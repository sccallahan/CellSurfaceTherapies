...
# all genes ----
#~~~~~~~~~~~~~~~~~~#
gene_search <- readRDS('/mnt/scratch/group/szhao264/callahan/projects/trial_selector/data/raw/allgenes.rds')

# llama
tmp_medllama <- gene_search
for (n in 1:3) {
...
saveRDS(tmp_medllama,
        '/mnt/scratch/group/szhao264/callahan/projects/trial_selector/output/results/allgenes_cell_surface_response_medllama_tempzero.rds')
