...
# Paths
input_dir = "/mnt/Data/Callahan/projects/trial_selector/data/openai_chunks_therapies_curated/"
output_dir = "/mnt/Data/Callahan/projects/trial_selector/data/openai_chunks_therapies_curated_answers/"
...
# Paths
input_dir = "/mnt/Data/Callahan/projects/trial_selector/data/openai_chunks_therapies_nci/"
output_dir = "/mnt/Data/Callahan/projects/trial_selector/data/openai_chunks_therapies_nci_answers/"
...
# Process all chunks
for i in range(1,220): # 219 chunks per guess method
    filename = f"nci_trial_therapy_guess_definition_chunk_{i}.jsonl"
    input_path = os.path.join(input_dir, filename)
    output_path = os.path.join(output_dir, f"response_nci_trial_therapy_guess_definition_chunk_{i}.jsonl")
...
# Process all chunks
for i in range(1,220): # 219 chunks per guess method
    filename = f"nci_trial_therapy_guess_drug_chunk_{i}.jsonl"
    input_path = os.path.join(input_dir, filename)
    output_path = os.path.join(output_dir, f"response_nci_trial_therapy_guess_drug_chunk_{i}.jsonl")
